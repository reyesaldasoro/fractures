function    [edgesArm,widthAtCM,dataOutput,outputLimits]=analyseLandmarkLunate(Xray,Xray_mask,Xray_info,currentFile,displayData)
...
q           = imdilate((edgesArm+linesArm)>0,ones(3));
linesMeasurement  = imdilate(q,ones(5));
